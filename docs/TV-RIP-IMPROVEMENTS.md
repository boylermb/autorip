...
| 7 | Add production-vs-aired mismatch detection + `_pending/` routing | M | medium (needs runtime-comparison heuristic tuning) | ⏳ next | A box set known to be production-order routes to `_pending/` |
